...
function LanguageSwitcher(props) {
  ...
  return (
    <>
      <Button className="h-40 w-64 bg-white" onClick={langMenuClick}>
        <img
        ...
        <Typography className="mx-4 font-semibold uppercase">{currentLanguage.id}</Typography>
      </Button>
      ...
      >
        {languages.map((lng) => (
          <MenuItem key={lng.id} onClick={() => handleLanguageChange(lng)} className="bg-white">
