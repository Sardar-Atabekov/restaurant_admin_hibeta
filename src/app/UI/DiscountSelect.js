  ...
  return (
    <Container>
      <FormControl sx={{ m: 1, width: 109, height: 40 }}>
        <StyledMenuItem>Скидка</StyledMenuItem>
        ...
        >
          <StyledMenuItem value="">10%</StyledMenuItem>
          <StyledMenuItem value={10}>20%</StyledMenuItem>
          <StyledMenuItem value={21}>30%</StyledMenuItem>
          <StyledMenuItem value={22}>40%</StyledMenuItem>
          <StyledMenuItem value={23}>50%</StyledMenuItem>
        </StyleSelect>
      </FormControl>
    </Container>
  );
