...
import TimeWorkDashboardHeader from './TimeWorkDashboardHeader';

function TimeWorkDashboardApp() {
  return (
    <FusePageSimple
      header={<TimeWorkDashboardHeader />}
      content={
        <>
          {useMemo(() => {
            const container = {
...
export default TimeWorkDashboardApp;
