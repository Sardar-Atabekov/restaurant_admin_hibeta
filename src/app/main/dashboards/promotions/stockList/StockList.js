...
const StockList = () => {
  ...
  const g = location.pathname === `/dashboards/promotions`;
  return (
    <div className="flex justify-between bg-grey rounded-2xl mt-32 h-68 items-center ">
      ...
      <Time>
        <NavLink
          to="/dashboards/promotions"
          className={({ isActive }) => (isActive && g ? 'active' : '')}
        >
          <p> Сегодня</p>
        </NavLink>
        <NavLink
          to="/dashboards/promotions/week"
          className={({ isActive }) => (isActive ? 'active' : '')}
        >
          <p> Неделя</p>
        </NavLink>
        <NavLink
          to="/dashboards/promotions/mounth"
          className={({ isActive }) => (isActive ? 'active' : 'kk')}
        >
          <p>Месяц</p>
        </NavLink>
        <NavLink
          to="/dashboards/promotions/years"
          className={({ isActive }) => (isActive ? 'active' : '')}
        >
          <p>Год</p>
        </NavLink>
